...
private Connection dBconnection;
	...
	public List<Hospital> findAll() {
		...
		try {
			PreparedStatement preparedStatement = this.dBconnection.prepareStatement("SELECT hospital_id, name, address, phone, email FROM hospital;");
	...
	public boolean createHospital(Hospital hospital) {
		...
		try {
			...
			if(resultSet.next() == false) {
				...
				PreparedStatement statement = dBconnection.prepareStatement("INSERT INTO hospital VALUES(?, ?, ?, ?, ?)");
